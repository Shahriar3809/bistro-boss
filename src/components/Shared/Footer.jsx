    ...
    return (
      <div>
        <footer className="flex flex-col md:flex-row justify-center text-center  text-neutral-content">
          <aside className=" flex p-10 md:w-1/2 w-full bg-[#1F2937] flex-col items-center gap-5">
          ...
          <nav className="text-center p-10 w-full md:w-1/2 bg-[#111827] flex flex-col items-center space-y-3">
            <h6 className="text-center font-bold text-2xl">Follow Us</h6>
